...
import 'schema/reasons_record.dart';
import 'schema/loan_requests_record.dart';
...
export 'schema/reasons_record.dart';
export 'schema/loan_requests_record.dart';
...
/// Functions to query ReasonsRecords (as a Stream and as a Future).
Stream<List<ReasonsRecord>> queryReasonsRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(ReasonsRecord.collection, ReasonsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<ReasonsRecord>> queryReasonsRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(ReasonsRecord.collection, ReasonsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<FFFirestorePage<ReasonsRecord>> queryReasonsRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
    ...
    queryCollectionPage(
      ReasonsRecord.collection,
      ReasonsRecord.serializer,
      queryBuilder: queryBuilder,
      nextPageMarker: nextPageMarker,
      pageSize: pageSize,
      isStream: isStream,
...
/// Functions to query LoanRequestsRecords (as a Stream and as a Future).
Stream<List<LoanRequestsRecord>> queryLoanRequestsRecord(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollection(
        LoanRequestsRecord.collection, LoanRequestsRecord.serializer,
        queryBuilder: queryBuilder, limit: limit, singleRecord: singleRecord);

Future<List<LoanRequestsRecord>> queryLoanRequestsRecordOnce(
        {Query Function(Query) queryBuilder,
        int limit = -1,
        bool singleRecord = false}) =>
    queryCollectionOnce(
...
Future<FFFirestorePage<LoanRequestsRecord>> queryLoanRequestsRecordPage({
  Query Function(Query) queryBuilder,
  DocumentSnapshot nextPageMarker,
  int pageSize,
  bool isStream,
